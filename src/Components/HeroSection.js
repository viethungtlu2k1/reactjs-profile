...
const HeroStyle = styled.div`
    ...
    .hero__socials, .hero__scrollDown{
        display: flex;
            ...
            <div className="hero">
                <div className="container">
                    <h1 className="hero__heading">
                        ...
                        <span className="hero__name">Viet Hung</span>
                    </h1>
                    ...
                    <div className="hero__infor">
                        <PText>
                            Tôi yêu thích công việc web này
                        </PText>
                        <Button btnClick="/projects" btnText="see my works" outline={false} />
                    </div>
